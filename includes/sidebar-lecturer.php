        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link <?php if($current_page=='submissions.php') echo 'active'; ?>" href="submissions.php">
                    <i class="bi bi-check2-square me-2"></i> Review / Grade
                </a>
            </li>
...
<aside class="lecturer-sidebar d-none d-lg-block bg-light border-end flex-shrink-0">
    <div class="sidebar-inner">
        <div class="px-3 py-3 border-bottom">
            <div class="fw-bold">Lecturer Base</div>
            <small class="text-muted">Lecturer Panel</small>
        </div>
...
.lecturer-sidebar .sidebar-inner{
...
.lecturer-sidebar .nav-link:hover,
.offcanvas .nav-link:hover{
    background: rgba(13,110,253,.10);
    color: #0d6efd;
}

.lecturer-sidebar .nav-link.active,
